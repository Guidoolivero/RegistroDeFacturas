<body>
    <form method="post">
        <h1 id="agregar">Agregar Factura</h1>
        <input type="text" name="cliente" placeholder="Numero de Cliente">
        <input type="text" name="name" placeholder="Nombre">
        <input type="text" name="lastname" placeholder="Apellido/Empresa">
        <input type="text" name="Fact_Numero" placeholder="numero de factura">
